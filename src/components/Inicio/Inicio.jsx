...
import imgInicio1 from '../../images/inicio_1.png';
import imgInicio2 from '../../images/inicio_2.png';
    ...
    const webDataInit = [
        {
            ...
            description: 
            <>
                <p>El roller derby es un deporte de contacto, velocidad y 
        ...
        },
        {
            ...
            subtitle: '',
            description: <>
                <p>MadRiders Roller Derby es un club deportivo elemental, autogestionado, formado por patinadores-as, árbitros y otros colaboradores,
                en el que el trabajo voluntario de todos hace que crezcamos y mejoremos cada día.</p>

                <p>Entrenamos en el polideportivo de Los Rosales (Villaverde Bajo) los Martes y Jueves 
                (20:30 - 22:00) y Domingos (10:00-14:00). El Roller Derby tiene dos variantes de juego
                el que se rige por el reglamento WFTDA y el reglamento World Skate. </p> 
